...
public class UserCreateCompleteDAO {	
	public int createUser(String family_name,String first_name,String family_name_kana,String first_name_kana,String sex,String email,String loginUserId,String password)throws SQLException{
	    int result=0;
		...
		try{
			...
			preparedStatement.setString(7,loginUserId);
