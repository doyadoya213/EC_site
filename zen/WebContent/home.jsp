...
<!--Header共通-->
  ...
  <div class="icon" style="height:0px;">
   <a href='<s:url action="GoHomeAction"/>'><img src="./images/iconzen.png" style="width:30%; height:120px;"></a>
  </div>
   ...
   <div class="search" style="height:0px;">
    <s:form action="ProductSearchAction" method="post" id="form1">
     ...
     <div class="search3">
      <input type="image" width="13%" height="35px" src="./images/search.png">
     </div>
    </s:form>
...
<div class="zen"><img src="./images/iconzen.png"></div>
   <div class="catchphrase">お酒の楽しいひとときを</div>
